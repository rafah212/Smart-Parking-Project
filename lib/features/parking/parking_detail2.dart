...
class _ParkingDetail2State extends State<ParkingDetail2> {
  ...
  void initState() {
    ...
    _now = firstAllowedDate;

    if (_now.isAfter(lastAllowedDate)) {
      _now = lastAllowedDate;
    }
  ...
  bool _canGoToNextMonth() {
    ...
    return !(_now.year == maxMonth.year &&
        _now.month == maxMonth.month);
  }

  bool _canGoToPreviousMonth() {
    final currentDate = DateTime.now();

    return !(_now.year == currentDate.year &&
        _now.month == currentDate.month);
  }
  ...
  String _getMonthName() {
    ...
    return AppData.translate(
      monthsEn[_now.month - 1],
      monthsAr[_now.month - 1],
    );
  }
