...
class PlaceDetailsScreen extends StatelessWidget {
  ...
  // دالة فتح الخرائط الخارجية (Google Maps)
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _InfoRow(
                        ...
                        text: '${place.availableSlots}/${place.totalSlots} ${AppData.translate('Total slots available', 'إجمالي المواقف المتاحة')}',
                      ),
                      const SizedBox(height: 8),
                      _InfoRow(
                        icon: Icons.social_distance_outlined,
                        text: '${place.distanceKm} ${AppData.translate('km', 'كم')}',
                      ),
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (_) => ParkingLotScreen(place: place),
                                    ),
                                  );
                                },
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Icon(Icons.
          search, color: Color(0xFF1A485F), size: 20),
          ...
          Expanded(
            child: Text(
              ...
              style: const TextStyle(color: Color(0xFF1A485F), fontSize: 13, fontWeight: FontWeight.w500),
            ),
          ),
          const SizedBox(width: 12),
        ],
...
class _TopHandle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: 81, height: 4,
      decoration: BoxDecoration(color: const Color(0x26777777), borderRadius: BorderRadius.circular(100)),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Expanded(
          child: Text(text, style: const TextStyle(color: Colors.black87, fontSize: 11, fontWeight: FontWeight.w400)),
        ),
      ],
    );
  }
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: OutlinedButton.icon(
        ...
        label: Text(text, style: const TextStyle(color: Color(0xFF07434E), fontSize: 13)),
